...
public class AddToCartHelper {
     ...
     * @param ty         移动结束时 v 的y坐标
     */
    public static void startAnimationForJd(final View v, int fromXDelta, int fromYDelta, int fx, int fy, int mx, int my, int tx, int ty, final AnimationListener listener) {
        AnimationSet set = new AnimationSet(false);
        TranslateAnimation translateAnimation1 = new TranslateAnimation(fromXDelta, mx - fx, fromYDelta, my - fy);
        translateAnimation1.setInterpolator(new DecelerateInterpolator());
        translateAnimation1.setRepeatCount(0);
     ...
     * @param ty         移动结束时 v 的y坐标
     */
    public static void startAnimationForAmazon(final View v, int fromXDelta, int fromYDelta, int fx, int fy, int mx, int my, int tx, int ty, final AnimationListener listener) {
        AnimationSet set = new AnimationSet(false);
        TranslateAnimation translateAnimation1 = new TranslateAnimation(fromXDelta, mx - fx, fromYDelta, my - fy);
